...
tf.app.flags.DEFINE_integer("learning_rate_step", 20000, "Every this many steps, do decay.")
...
tf.app.flags.DEFINE_integer("seq_length_in", 25, "Number of frames to feed into the encoder. 25 fps")
